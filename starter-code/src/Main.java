...
public class functions_and_scope {
    /**
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            setStoreName("Hotel Chocolat");

            // 2) Complete the greetCustomer() method below
            String greeting = greetCustomer("Joaquin");
            ...
            System.out.println("25% off $79.99 is $" + two_decimals.format(salePrice));

            // you can also nest a call to getSalePrice() inside a call to println()
            System.out.println("15% off $24.95 is $" + two_decimals.format(getSalePrice(24.95, 0.15)));

            two_decimals.format(getSalePrice(75.5, 0.3));
            ...
            System.out.println("take an extra 50% off after the 25% discount from $79.99 to $ " + two_decimals.format(clearancePrice));
            getClearancePrice(75.5, 0.45);
            ...
            System.out.println("price after bulk discount: $" + two_decimals.format(salePriceForEachItem));
        ...
        public static void setStoreName(String name) {
            ...
            mStoreName = name; // I can access this variable because it is public and so available to everyone
        ...
        public static double getSalePrice(double fullPrice, double discount) {
            ...
            System.out.println( two_decimals.format(discount) + "% off $" + fullPrice + "is $" + two_decimals.format(salePrice));
            return salePrice;
        ...
        public static double getClearancePrice(double fullPrice, double discount) {
            ...
            double salePrice = (fullPrice * (1 - discount) ) * .5;
        ...
        public static double getBulkDiscount(int quantityPurchased) {
            ...
            if (quantityPurchased > 4 && quantityPurchased <= 9 ) {
                discount = 0.05;
            }
